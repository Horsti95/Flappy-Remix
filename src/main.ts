...
app.innerHTML = `
  <section id="stage" role="application" aria-label="PaperPlane play area" class="relative w-full h-full max-w-md max-h-[90vh] aspect-[9/16] mx-auto bg-sky-day overflow-hidden touch-none select-none">
